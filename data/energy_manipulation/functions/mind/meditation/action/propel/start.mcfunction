...
execute store result storage energy_manipulation:op macro_data.initial_speed double 1 run scoreboard players operation @s xem.mind.meditation.action.propel < #9 xconst
