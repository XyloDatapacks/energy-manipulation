...
execute if score #xem.mind.meditation.from_body_check.disposed xem.op matches 1 run function energy_manipulation:mind/meditation/from_body_check/update_player_mind_data/check with storage energy_manipulation:op macro_data
...
execute if score #xem.mind.meditation.from_body_check.player_found xem.op matches 1 unless score #xem.mind.meditation.from_body_check.player_start_time xem.op = @s xlib.internal.clone.generate.start_time store success score #xem.mind.meditation.from_body_check.disposed xem.op run function xylo_library:internal/clone/dispose/kill_from_marker/remove_from_player_storage_and_kill with storage energy_manipulation:op macro_data
execute if score #xem.mind.meditation.from_body_check.disposed xem.op matches 1 run return 1
