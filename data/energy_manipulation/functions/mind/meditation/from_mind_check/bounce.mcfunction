...
execute unless score #xem.spell.run.getters.target._reroute.reroute_state xem.op matches 1 run function energy_manipulation:mind/meditation/attack/start with storage energy_manipulation:op target_out[-1]
