...
execute store result score #xem.mind.meditation.from_mind_check.disposed xem.op run function energy_manipulation:mind/meditation/from_mind_check/check with storage energy_manipulation:op macro_data
