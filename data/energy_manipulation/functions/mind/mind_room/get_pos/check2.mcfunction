...
scoreboard players operation #xem.mind.mind_room.z xem.op = #xem.mind.mind_room.x xem.op
scoreboard players operation #xem.mind.mind_room.z xem.op -= #xem.mind.mind_room.id xem.op
scoreboard players operation #xem.mind.mind_room.z xem.op += #xem.mind.mind_room.n^2+n xem.op
