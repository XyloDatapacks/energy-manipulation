...
execute unless score @s xlib.player.reapawn_status matches -1 run scoreboard players add @s[tag=!xem.mind.expand.is_expanding] xem.mind.focus 1
...
scoreboard players remove @s[tag=xem.mind.expand.is_expanding] xem.mind.focus 10
