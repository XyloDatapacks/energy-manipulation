...
data modify storage energy_manipulation:spell nodes_values.feature set value [{value:"none"},{value:"sneaking",incompatible_parent:["spell","projectile"]},{value:"swimming",incompatible_parent:["spell","projectile"]},{value:"on_fire",incompatible_parent:["spell"]},{value:"on_ground",incompatible_parent:["spell"]},{value:"in_air",incompatible_parent:["spell"]},{value:"shape_projectile",compatible_parent:["","spell","objects"]},{value:"shape_sprout",compatible_parent:["","spell","objects"]},{value:"shape_turret",compatible_parent:["","spell","objects"]}]
