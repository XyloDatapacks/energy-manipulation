...
data modify storage energy_manipulation:spell nodes_values.movement set value [{value:"none",cost:0},{value:"parabolic",cost:2,incompatible_shapes:["turret"]},{value:"straight",cost:2.5,incompatible_shapes:["turret"]},{value:"seek",cost:4,incompatible_shapes:["turret"]},{value:"follow",cost:2,compatible_shapes:["","turret"]}]
...
data modify storage energy_manipulation:spell nodes_values.target set value [{value:"this"},{value:"none"},{value:"caster"},{value:"subject"},{value:"objects"},{value:"marked_entity"},{value:"attacker"},{value:"player",incompatible_parent_value:["self"]},{value:"mob",incompatible_parent_value:["self"]},{value:"player_and_mob",incompatible_parent_value:["self"]},{value:"enemy",incompatible_parent_value:["self"]},{value:"ally",incompatible_parent_value:["self"]},{value:"animal",incompatible_parent_value:["self"]},{value:"item",incompatible_parent_value:["self"]},{value:"projectile",incompatible_parent_value:["self"]},{value:"spell",incompatible_parent_value:["self"]}]
...
data modify storage energy_manipulation:spell nodes_values.feature set value [{value:"none"},{value:"sneaking",incompatible_parent:["spell","projectile"]},{value:"swimming",incompatible_parent:["spell","projectile"]},{value:"on_fire",incompatible_parent:["spell"]},{value:"on_ground",incompatible_parent:["spell"]},{value:"in_air",incompatible_parent:["spell"]},{value:"damage_taken",incompatible_parent:["player_and_mob","mob","enemy","ally","animal","item","spell","projectile"]},{value:"damage_dealt",incompatible_parent:["player_and_mob","mob","enemy","ally","animal","item","spell","projectile"]},{value:"damage_dealt_direct",incompatible_parent:["player_and_mob","mob","enemy","ally","animal","item","spell","projectile"]},{value:"shape_projectile",compatible_parent:["","spell","objects"]},{value:"shape_sprout",compatible_parent:["","spell","objects"]},{value:"shape_turret",compatible_parent:["","spell","objects"]}]
