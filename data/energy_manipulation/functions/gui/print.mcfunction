...
execute if score #xem.gui.has_book xem.op matches 0 run scoreboard players operation @s xlib.internal.gui.priority > #0 xconst
...
execute if score #xem.gui.has_book xem.op matches 1 run scoreboard players operation @s xlib.internal.gui.priority > #1 xconst
