# fill
execute store result storage energy_manipulation:op temp_data int 1 run scoreboard players operation #xem.jar_of_energy.fill.last_count xem.op = #xem.const.jar_of_energy.fill.limit xem.const
