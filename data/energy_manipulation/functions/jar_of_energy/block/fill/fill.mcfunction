...
execute if entity @s[tag=xem.jar_of_energy.sun] unless data storage energy_manipulation:op temp_item.tag.xylo{id:"energy_manipulation:sun_energy"} run return 0
execute if entity @s[tag=xem.jar_of_energy.ground] unless data storage energy_manipulation:op temp_item.tag.xylo{id:"energy_manipulation:ground_energy"} run return 0
execute if entity @s[tag=xem.jar_of_energy.soul] unless data storage energy_manipulation:op temp_item.tag.xylo{id:"energy_manipulation:soul_energy"} run return 0
execute if entity @s[tag=xem.jar_of_energy.dark] unless data storage energy_manipulation:op temp_item.tag.xylo{id:"energy_manipulation:dark_energy"} run return 0
execute if entity @s[tag=xem.jar_of_energy.void] unless data storage energy_manipulation:op temp_item.tag.xylo{id:"energy_manipulation:void_energy"} run return 0
