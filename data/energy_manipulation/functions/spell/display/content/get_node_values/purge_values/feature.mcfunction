...
function energy_manipulation:spell/display/content/get_node_values/purge_values/feature/remove_incompatible with storage energy_manipulation:op macro_data