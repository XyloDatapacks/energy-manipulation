...
function energy_manipulation:spell/display/content/get_node_values/get_values_selected_value with storage energy_manipulation:op get_selected_node_values
