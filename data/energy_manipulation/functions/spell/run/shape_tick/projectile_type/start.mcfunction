#dead caster stop
execute if score #xem.spell.run.caster_still_alive xem.op matches 0 run return run execute at @s on vehicle run function energy_manipulation:spell/run/shape_tick/projectile_type/spell_fail
