#dead caster stop
execute if score #xem.spell.run.caster_still_alive xem.op matches 0 run return run function energy_manipulation:spell/run/shape_tick/turret_type/spell_fail
