...
execute if data storage energy_manipulation:op elements_array[0].uuid run function energy_manipulation:spell/run/getters/target/validate_uuid/repeat_check
