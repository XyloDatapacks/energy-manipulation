...
execute as 545ec994-ae69-485d-9604-981ce1612a99 run function energy_manipulation:spell/run/getters/direction/facing_away/xlm.rotate with storage energy_manipulation:op macro_data
