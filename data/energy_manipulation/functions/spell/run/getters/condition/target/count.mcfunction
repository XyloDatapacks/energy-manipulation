...
execute unless score #xem.spell.run.getters.condition.target.count xem.op >= #xem.spell.run.getters.condition.target.min_count xem.op run return 0
execute if data storage energy_manipulation:op condition_in.target_count.max_count unless score #xem.spell.run.getters.condition.target.count xem.op <= #xem.spell.run.getters.condition.target.max_count xem.op run return 0
