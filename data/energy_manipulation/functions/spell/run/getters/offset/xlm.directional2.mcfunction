...
$execute in minecraft:overworld positioned $(initial_position_x) $(initial_position_y) $(initial_position_z) rotated $(initial_rotation_yawn) $(initial_rotation_pitch) run tp @s ^$(position_x) ^$(position_y) ^$(position_z)
