...
# ride
data modify storage energy_manipulation:op macro_data set value {uuid:"none"}
...
function energy_manipulation:spell/run/effect/pull/ride with storage energy_manipulation:op macro_data
