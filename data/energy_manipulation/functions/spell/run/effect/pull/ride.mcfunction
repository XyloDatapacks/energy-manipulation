...
#do stuff (-0.388)
$execute unless score #xem.spell.run.effect.pull.was_riding xem.op matches 2 at $(uuid) run summon minecraft:armor_stand ~ ~-0.3866 ~ {Small:1b,Invisible:1b,NoGravity:0b,DisabledSlots:4144959,Motion:[0.0d,-0.078d,0.0d],Tags:["smithed.entity","smithed.strict","xylo_iris.ignore","xlib.non_interactive","xem.spell.run.effect.pull.entity","xem.spell.run.effect.pull.entity_new"]}
...
$execute if score #xem.spell.run.effect.pull.was_riding xem.op matches 2 at $(uuid) run summon minecraft:armor_stand ~ ~-0.9874 ~ {Small:1b,Invisible:1b,NoGravity:0b,DisabledSlots:4144959,Motion:[0.0d,-0.078d,0.0d],Tags:["smithed.entity","smithed.strict","xylo_iris.ignore","xlib.non_interactive","xem.spell.run.effect.pull.entity","xem.spell.run.effect.pull.entity_new"]}
