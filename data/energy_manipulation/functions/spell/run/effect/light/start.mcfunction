...
execute store result storage energy_manipulation:op macro_data.spell_power int 0.08 run scoreboard players add #xem.spell.run.effect.spell_power xem.op 30

# light entity
execute if score xem.spell.run.effect.has_target_entity xem.op matches 1 store result storage energy_manipulation:op macro_data.spell_power int 0.08 run scoreboard players add #xem.spell.run.effect.spell_power xem.op 30
...
# light block
execute if score xem.spell.run.effect.has_target_entity xem.op matches 0 store result storage energy_manipulation:op macro_data.spell_power int 0.15 run scoreboard players operation #xem.spell.run.effect.spell_power xem.op < #100 xconst
