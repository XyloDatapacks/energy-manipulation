...
execute if score xem.spell.run.effect.has_target_entity xem.op matches 1 run function energy_manipulation:spell/run/effect/release_effect/apply_effect with storage energy_manipulation:op macro_data
...
execute if score xem.spell.run.effect.has_target_entity xem.op matches 0 run function energy_manipulation:spell/run/effect/release_effect/lingering
