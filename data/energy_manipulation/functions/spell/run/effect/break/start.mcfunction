...
# dmg entity
execute if score xem.spell.run.effect.has_target_entity xem.op matches 1 store result storage energy_manipulation:op macro_data.spell_power double 0.10 run scoreboard players get #xem.spell.run.effect.intensity xem.op
