...
execute unless score #xem.spell.run.effect.intensity xem.op matches 50.. unless block ~ ~ ~ #xylo_library:unbreakable unless block ~ ~ ~ #xylo_library:high_resistance run scoreboard players set #xem.spell.run.effect.break.can_break xem.op 1
execute if score #xem.spell.run.effect.intensity xem.op matches 50.. unless block ~ ~ ~ #xylo_library:unbreakable run scoreboard players set #xem.spell.run.effect.break.can_break xem.op 1
# exit
