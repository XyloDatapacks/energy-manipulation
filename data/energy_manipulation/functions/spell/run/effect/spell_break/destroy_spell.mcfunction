...
$execute at $(uuid) run particle minecraft:glow ~ ~ ~ 0.1 0.1 0.1 1 20 force

#==<Validation Exit>==#
execute unless score #xem.spell.run.effect.validate_target xem.op matches -2..-1 unless score #xem.spell.run.effect.validate_target xem.op matches -3 run return 0
#=====================#
