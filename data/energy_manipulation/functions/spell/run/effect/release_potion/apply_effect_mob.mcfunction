...
# summon aoe cloud
summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["xem.spell.run.effect.release_potion_new"],CustomName:'{"translate":"energy_manipulation.spell.run.effect.release_potion.aoe"}',Age:-1,WaitTime:-1,Radius:2.0f,Duration:2,RadiusOnUse:-2f}
