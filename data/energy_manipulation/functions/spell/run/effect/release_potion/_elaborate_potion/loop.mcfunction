...
$execute if score #xem.spell.run.effect.release_potion.elaborate_potion.duration.$(effect_i) xem.op matches ..0 run data remove storage energy_manipulation:op spell_effect.potion.tag.custom_potion_effects[$(effect_i)] 