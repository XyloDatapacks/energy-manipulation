...
execute if score xem.spell.run.getters.target.found xem.op matches 1 run data modify entity @s data.energy_manipulation.shape.movement.consolidated_follow.target set from storage energy_manipulation:op target_out[0].uuid
