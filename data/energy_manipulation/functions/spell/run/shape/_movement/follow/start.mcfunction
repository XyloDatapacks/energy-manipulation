...
data modify storage energy_manipulation:op selected_concatenate.concatenate.shape.movement.consolidated_follow set value {position_x:0,position_y:0,position_z:0,follow_rotation:""}
