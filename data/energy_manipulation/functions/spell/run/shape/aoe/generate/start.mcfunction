...
# apply data
execute on vehicle run function energy_manipulation:spell/run/shape/aoe/generate/summon_data
...
function energy_manipulation:spell/run/shape/aoe/generate/increase_aoes_counter with storage energy_manipulation:op running_spell_data
