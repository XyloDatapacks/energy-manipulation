...
function energy_manipulation:spell/run/shape/_projectile_type/generate/summon with storage energy_manipulation:op macro_data
...
function energy_manipulation:spell/run/shape/_projectile_type/generate/increase_projectiles_counter with storage energy_manipulation:op running_spell_data
