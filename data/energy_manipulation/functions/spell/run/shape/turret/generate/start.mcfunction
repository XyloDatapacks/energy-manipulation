# summon
function energy_manipulation:spell/run/shape/turret/generate/summon_with_direction with storage energy_manipulation:op macro_data
...
# apply data
execute on vehicle run function energy_manipulation:spell/run/shape/turret/generate/summon_data
...
# conditions
execute if data storage energy_manipulation:op selected_concatenate.concatenate.shape.condition{value:"none"} run function energy_manipulation:spell/run/shape/turret/generate/condition/none
execute if data storage energy_manipulation:op selected_concatenate.concatenate.shape.condition{value:"cooldown"} run function energy_manipulation:spell/run/shape/turret/generate/condition/cooldown
execute if data storage energy_manipulation:op selected_concatenate.concatenate.shape.condition{value:"target"} run function energy_manipulation:spell/run/shape/turret/generate/condition/target
...
execute if data storage energy_manipulation:op selected_concatenate.concatenate.shape.fire_mode{value:"repeat"} run function energy_manipulation:spell/run/shape/turret/generate/fire_mode/repeat
...
function energy_manipulation:spell/run/shape/turret/generate/increase_turrets_counter with storage energy_manipulation:op running_spell_data
